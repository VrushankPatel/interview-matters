...
- DevOps: ci-cd-pipelines, devops-infrastructure-as-code, kubernetes-basics, kubernetes-orchestration, docker-containerization, docker-best-practices
- Tooling: (none yet)
